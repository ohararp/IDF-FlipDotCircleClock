...
- [x] **Step 3:** OLED display (SH1107) + CP-style layout, WiFi dot, network status, QR code
...
- [ ] **Step 13:** Web server + JSON API + OTA + persistent logging (4 sub-phases: frontend → API → logging → OTA)
