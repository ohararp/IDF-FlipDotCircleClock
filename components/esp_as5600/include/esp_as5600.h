#ifndef _ESP_AS5600_H_
#define _ESP_AS5600_H_
 ...
 * @return ESP_OK on success otherwise corresponding i2c_master_write_read_device error code
 */
void as5600_get_power_mode(i2c_master_dev_handle_t handle, as5600_power_mode_type_e* power_mode);
 ...
 * @return ESP_OK on success otherwise corresponding i2c_master_write_read_device error code
 */
void as5600_get_hysteresis(i2c_master_dev_handle_t handle, as5600_hysteresis_type_e* hysteresis);
 ...
 * @return ESP_OK on success otherwise corresponding i2c_master_write_read_device error code
 */
void as5600_get_output_stage(i2c_master_dev_handle_t handle, as5600_output_stage_type_e* output_stage);
 ...
 * @return ESP_OK on success otherwise corresponding i2c_master_write_read_device error code
 */
void as5600_get_pwm_freq(i2c_master_dev_handle_t handle, as5600_pwm_freq_type_e* pwm_freq);
 ...
 * @return ESP_OK on success otherwise corresponding i2c_master_write_read_device error code
 */
void as5600_get_slow_filter(i2c_master_dev_handle_t handle, as5600_slow_filter_type_e* slow_filter);
 ...
 * @return ESP_OK on success otherwise corresponding i2c_master_write_read_device error code
 */
void as5600_get_fast_filter(i2c_master_dev_handle_t handle, as5600_fast_filter_type_e* fast_filter);
 ...
 * @return ESP_OK on success otherwise corresponding i2c_master_write_read_device error code
 */
void as5600_get_watchdog(i2c_master_dev_handle_t handle, as5600_watchdog_type_e* watchdog);
 ...
 */
esp_err_t as5600_set_power_mode(i2c_master_dev_handle_t handle, as5600_power_mode_type_e power_mode);
 ...
 * @return ESP_OK on success otherwise corresponding i2c_master_write_to_device error code
 */
esp_err_t as5600_set_hysteresis(i2c_master_dev_handle_t handle, as5600_hysteresis_type_e hysteresis);
 ...
 * @return ESP_OK on success otherwise corresponding i2c_master_write_to_device error code
 */
esp_err_t as5600_set_output_stage(i2c_master_dev_handle_t handle, as5600_output_stage_type_e output_stage);
 ...
 * @return ESP_OK on success otherwise corresponding i2c_master_write_to_device error code
 */
esp_err_t as5600_set_pwm_freq(i2c_master_dev_handle_t handle, as5600_pwm_freq_type_e pwm_freq);
 ...
 * @return ESP_OK on success otherwise corresponding i2c_master_write_to_device error code
 */
esp_err_t as5600_set_slow_filter(i2c_master_dev_handle_t handle, as5600_slow_filter_type_e slow_filter);
 ...
 * @return ESP_OK on success otherwise corresponding i2c_master_write_to_device error code
 */
esp_err_t as5600_set_fast_filter(i2c_master_dev_handle_t handle, as5600_fast_filter_type_e fast_filter);
 ...
 * @return ESP_OK on success otherwise corresponding i2c_master_write_to_device error code
 */
esp_err_t as5600_set_watchdog(i2c_master_dev_handle_t handle, as5600_watchdog_type_e watchdog);
 ...
 */
esp_err_t as5600_set_mang(i2c_master_dev_handle_t handle, uint16_t max_angle, as5600_burn_settings_context_t* context);
 ...
 */
esp_err_t as5600_set_mpos(i2c_master_dev_handle_t handle, uint16_t stop_position, as5600_burn_angle_context_t* context);
 ...
 * @note this function only saves data in the register, you need commit changes using burn angle command
 */
esp_err_t as5600_set_zpos(i2c_master_dev_handle_t handle, uint16_t start_position, as5600_burn_angle_context_t* context);
 ...
 */
esp_err_t as5600_burn_angle(i2c_master_dev_handle_t handle, as5600_burn_angle_context_t* context);
 ...
 * @note Please refer to AS5600 documentation for more details
 */
esp_err_t as5600_burn_settings(i2c_master_dev_handle_t handle, as5600_burn_settings_context_t* context);
 ...
 */
bool as5600_burn_verify(i2c_master_dev_handle_t handle, uint8_t command, void* context);

#endif  // _ESP_AS5600_H_
